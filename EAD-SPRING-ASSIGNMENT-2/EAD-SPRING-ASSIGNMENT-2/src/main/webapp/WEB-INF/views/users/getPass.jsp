...
<body align="center">
	<div class="container"
		...
		<form modelAttribute="pass" method="get" action="/home">
			<input cssClass="form-control col-lg-6" id="regId" name = "regId" path="regId"
			...
			<div class="form-group">
				...
				</select> <br> <br> <label><input type= "radio" id="pricePlan"
						name="pricePlan" value="Daily"
						onchange="getPriceFunction(this.value)"/>Daily</label> <label><input type= "radio"
						id="pricePlan" name="pricePlan" value="Monthly"
						onchange="getPriceFunction(this.value)"/>Monthly</label> <label><input type= "radio"
						id="pricePlan" name="pricePlan" value="Yearly"
						onchange="getPriceFunction(this.value)"/>Yearly</label> <br>
				<br> <input type="button" value="getPass" id="getPass"
					onclick="getPassFunction()"> <br> <br> <label>Your
					price is</label> <input type="text" name="price" id="price" size="5%">
				<input type="text" name="priceInINR" id="priceInINR"
