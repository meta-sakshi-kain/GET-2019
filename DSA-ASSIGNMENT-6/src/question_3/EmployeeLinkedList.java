package question_3;
//class to implement quick sort on employee linked list
public class EmployeeLinkedList {
	 ...
	 */
	//method to insert employees to linked list
	 ...
	 * @return
	 */
	//partition the list on the basis of pivot element
