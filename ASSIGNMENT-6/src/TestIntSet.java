...
//Test case to check if an element is present in the set
@Test
...
// Test case to check the size of the set
@Test
...
// Test case to check if a set is subset of the given set
@Test
...
//Test case to give the union of the sets
@Test
public void checkUnionOfSets(){
	assertArrayEquals(new IntSet(new int[] { 1, 2, 3, 4 }).getArray(),IntSet.union(new IntSet(new int[] { 1, 2, 3 }),new IntSet(new int[] { 2, 4 })).getArray());
	assertArrayEquals(new IntSet(new int[] { 5, 8, 10, 15 }).getArray(),IntSet.union(new IntSet(new int[] { 5, 8, 10 }),new IntSet(new int[] { 8, 15 })).getArray());
	assertArrayEquals(new IntSet(new int[] { 2, 9, 21, 22, 56 }).getArray(),IntSet.union(new IntSet(new int[] { 2, 9, 21 }),new IntSet(new int[] { 21, 22, 56 })).getArray());
	assertArrayEquals(new IntSet(new int[] { 4, 7, 10, 15, 18, 30 }).getArray(),IntSet.union(new IntSet(new int[] { 4, 7, 10 }),new IntSet(new int[] { 15, 18, 30 })).getArray());
}
}
