package question_2;
//class to implement insertion sort on linked list
public class InsertionSort {
	 ...
	 * @return
	 */
	//method to sort empployees on the basis of salary
	 ...
	 */
	//when the node is already sorted in the list
	 ...
	 * @param list 
	 */
	//when the element to be added in sorted list
