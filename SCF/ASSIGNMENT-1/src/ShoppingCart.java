...
if(cartItemsList.isEmpty()){
    ...
    System.out.println("S.NO." + "   " + "Product name" + "   " + "Product quantity"+ "   " + "Product price");
	for(int i = 0; i < cartItemsList.size(); i++) {
		System.out.println(i+1 + "        " + cartItemsList.get(i).getItemName() + "           " + cartItemsList.get(i).getQuantity()+ "                  " + cartItemsList.get(i).getPrice());
	}
	System.out.println();
}
}
